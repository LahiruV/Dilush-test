import { ReadOnlyProps } from '@peerless/models';
...
export const ReadOnlyProvider: FC<ReadOnlyProps> = ({ readOnly, setReadOnly, children }) => {
  const contextValue = useMemo(() => ({ readOnly, setReadOnly }), [readOnly, setReadOnly]);
