import { messageTypeEnum, pageModeEnum, RootState, setCustomerEnduserPageMode, setIsCustomerEnduserTblPopupOpen, setIsCustomerEnduserTransferPopupOpen, 
  setSelectedCustomerEnduser, setSelectedCustomerForEnduserTransfer, showMessage } from "@peerless-cms/store";
...
export function CustomerEndusersList(props: CustomerEndusersListProps) {
    ...
    return (
        <div>       
            ...
            <DataGrid dataTable={enduserListGrid} data={customerEndusersData} renderStatusContent={renderStatusContent} />
