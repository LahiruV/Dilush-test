...
export function LeedCustomerOpportunityForm(props: LeedCustomerOpportunityFormProps) {
    ...
    const [productData, setProductData] = useState<{catlogCode: string, description: string, units: number, 
    ...
    const footer = (
        ...
        {opportunityPageMode === pageModeEnum.New ? (<Button type='button' disabled={isSaving} variant='outline-dark' className='btn-submit' onClick={handleExternalSubmit}>
            {isSaving ? 'Saving...' : 'Save Details'}
        </Button>) : 
        (<Button type='button' disabled={isSaving} variant='outline-dark' className='btn-submit' onClick={handleExternalSubmit}>
