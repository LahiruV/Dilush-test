...
import { ComboBoxProps, FormInput, ToastManager } from "@peerless/controls";
        ...
        <div className='content margin-top-20'>           
            ...
            <footer>
                <div className='form-button-container'>   
                    ...
                    {contactPersonPageMode === pageModeEnum.New ? (<Button disabled={isSaving} type='button' variant='outline-dark' className='btn-submit' onClick={handleExternalSubmit}>
