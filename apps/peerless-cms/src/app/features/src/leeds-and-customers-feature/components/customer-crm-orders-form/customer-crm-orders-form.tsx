...
import { ButtonWidget, DataGrid, FormInput, ToastManager } from "@peerless/controls";
      ...
      <footer>
        <div className='form-button-container footer-content'>
          ...
          {crmOrdersPageMode === pageModeEnum.New ? (
            ...
            (<>
              ...
              {contactType == contactTypeEnum.enduser &&
                <ButtonWidget
                  id='customer-crm-send-button'
                  classNames='k-button-md k-rounded-md k-button-solid k-button-solid-primary footer-save-button'
                  Function={() => handleResendEmail()}
                  name={isSendingMail ? 'Sending...' : 'Send Details'}
                />}
            </>)
          ...
          {contactType == contactTypeEnum.customer &&
            <ButtonWidget
              id='customer-crm-complete-button'
              classNames='k-button-md k-rounded-md k-button-solid k-button-solid-primary footer-save-button-extended'
              Function={() => handleExternalSubmit('complete')}
              name={isCompleting ? 'Completing...' : 'Complete Details'}
            />}
        </div>
      </footer>
