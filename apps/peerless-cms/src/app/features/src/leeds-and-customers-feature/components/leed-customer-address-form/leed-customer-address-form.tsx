...
import { FormInput, PageLoader, ToastManager } from "@peerless/controls";
          ...
          <ToastMessages ref={messagesRef} />          
            ...
            <footer>
                <div className='form-button-container'>   
                    ...
                    {addressMode === pageModeEnum.New ? (<Button disabled={isProcessing} type='button' variant='outline-dark' className='btn-submit' onClick={handleExternalSubmit}>
                        {isProcessing? 'Saving...' : 'Save Details'}
                    </Button>) : 
                    (<Button disabled={isProcessing} type='button' variant='outline-dark' className='btn-submit' onClick={handleExternalSubmit}>
