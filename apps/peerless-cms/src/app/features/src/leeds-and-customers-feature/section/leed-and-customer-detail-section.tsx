...
export function LeedAndCustomerDetailSection(props: LeedAndCustomerDetailSectionProps) {
  ...
  const onClickBackToList = () => {
    contactType === "lead" ? navigate('/leeds-and-customers/lead/') : contactType === "customer" ?
      navigate('/leeds-and-customers/customer/') : contactType === "enduser" ?
        navigate('/leeds-and-customers/enduser/') : navigate('/leeds-and-customers/');
  }
