...
export const dashBusinessDColumns = (businessSalesEnqGroupBy: any, titleData: TitleDataInfo) => [
    ...
    {
        field: 'm_m5D', title: titleData.salesMoth2 || '', width: 110, filterable: true,
        cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm_m4D', title: titleData.salesMoth3 || '', width: 110, filterable: true,
        cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm_m3D', title: titleData.salesMoth4 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm_m2D', title: titleData.salesMoth5 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm_m1D', title: titleData.salesMoth6 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm1D', title: titleData.salesMoth7 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm2D', title: titleData.salesMoth8 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm3D', title: titleData.salesMoth9 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm4D', title: titleData.salesMoth10 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm5D', title: titleData.salesMoth11 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm6D', title: titleData.salesMoth12 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
...
export const dashBusinessTColumns = (businessSalesEnqGroupBy: any, titleData: TitleDataInfo) => [
    ...
    {
        field: 'm_m5T', title: titleData.salesMoth2 || '', width: 110, filterable: true,
        cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {(props.dataItem[props.field || ''] || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
    ...
    {
        field: 'm_m4T', title: titleData.salesMoth3 || '', width: 110, filterable: true,
        cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {(props.dataItem[props.field || ''] || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
    ...
    {
        field: 'm_m3T', title: titleData.salesMoth4 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {(props.dataItem[props.field || ''] || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
    ...
    {
        field: 'm_m2T', title: titleData.salesMoth5 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {(props.dataItem[props.field || ''] || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
    ...
    {
        field: 'm_m1T', title: titleData.salesMoth6 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {(props.dataItem[props.field || ''] || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
    ...
    {
        field: 'm1T', title: titleData.salesMoth7 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {(props.dataItem[props.field || ''] || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
    ...
    {
        field: 'm2T', title: titleData.salesMoth8 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {(props.dataItem[props.field || ''] || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
    ...
    {
        field: 'm3T', title: titleData.salesMoth9 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {(props.dataItem[props.field || ''] || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
    ...
    {
        field: 'm4T', title: titleData.salesMoth10 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {(props.dataItem[props.field || ''] || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
    ...
    {
        field: 'm5T', title: titleData.salesMoth11 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {(props.dataItem[props.field || ''] || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
    ...
    {
        field: 'm6T', title: titleData.salesMoth12 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {(props.dataItem[props.field || ''] || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
...
export const dashBusinessUColumns = (businessSalesEnqGroupBy: any, titleData: TitleDataInfo) => [
    ...
    {
        field: 'm_m5U', title: titleData.salesMoth2 || '', width: 110, filterable: true,
        cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm_m4U', title: titleData.salesMoth3 || '', width: 110, filterable: true,
        cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm_m3U', title: titleData.salesMoth4 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm_m2U', title: titleData.salesMoth5 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm_m1U', title: titleData.salesMoth6 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm1U', title: titleData.salesMoth7 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm2U', title: titleData.salesMoth8 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm3U', title: titleData.salesMoth9 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm4U', title: titleData.salesMoth10 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm5U', title: titleData.salesMoth11 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
    ...
    {
        field: 'm6U', title: titleData.salesMoth12 || '', width: 110, filterable: true
        , cell: (props: GridCellProps) => (
            <td style={{ textAlign: 'right' }
            }>
                {Math.round(props.dataItem[props.field || ''] || 0).toLocaleString()}
